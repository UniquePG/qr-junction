...
export default function QRPage() {
  return (
    <div className="min-h-screen bg-[#0b0f19] text-white relative overflow-hidden">
      ...
      <div className="absolute bottom-[20%] right-[-10%] w-[500px] h-[500px] rounded-full bg-secondary/5 blur-[130px] pointer-events-none" />
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 pt-28 pb-12 relative z-10">
        <Suspense fallback={
          <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-4">
            ...
            <p className="text-slate-400 text-sm">Initializing customizer engine...</p>
          </div>
        }>
          <QRGeneratorWrapper />
        </Suspense>
